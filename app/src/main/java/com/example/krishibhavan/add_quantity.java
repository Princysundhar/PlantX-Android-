                ...
                if(flag==0){
                    ...
                    StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                            Toast.makeText(add_quantity.this, "Quantity added", Toast.LENGTH_SHORT).show();
                                            Intent i = new Intent(getApplicationContext(),Home.class);
                                            startActivity(i);

                                        }
                                        if (jsonObj.getString("status").equalsIgnoreCase("no")) {
                                            Toast.makeText(add_quantity.this, "Already Added", Toast.LENGTH_SHORT).show();
                                            Intent i = new Intent(getApplicationContext(),Home.class);
                                            startActivity(i);
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            params.put("stk_id",sh.getString("stk_id",""));
